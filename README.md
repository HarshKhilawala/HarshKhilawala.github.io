# Personal Academic Website - Harsh Khilawala
...
- [Resume](https://drive.google.com/file/d/12eZa2JcW5iyEztIoBNN-T33HWiandJR_/view?usp=sharing) | [CV (TBA)]()
...
These websites may be useful to other academics and researchers. You are welcome to use them, but if you do please make sure to:
* replace details specific to the Carnegie Mellon computational imaging lab (for example, favicon) as appropriate,
* use your own Font Awesome kit icons,
* **Please add an acknowledgment to [CMU CI Lab's Github repository](https://github.com/cmu-ci-lab/website_templates)!**
